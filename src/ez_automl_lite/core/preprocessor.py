...
class AutoPreprocessor:
    ...
    def detect_useless_columns_with_feature_engine(
    ...
    def get_feature_metadata(self, df: pd.DataFrame | None) -> dict[str, Any]:
        """
        ...
        if "__target__" in self.label_encoders:
            ...
            target_mapping = {int(idx): str(cls) for idx, cls in enumerate(le.classes_)}
